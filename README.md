...
The purpose of this being open source is to detail the more lower level programming concepts that get overlooked and build a reference for onlookeers, from programming to design concepts, when working on an engine from the ground up through a beginner's perspective.
